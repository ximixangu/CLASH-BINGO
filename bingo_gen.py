...
if __name__ == "__main__":
    ...
    with st.sidebar.expander("Parameters", expanded=False):
        ...
        with col1:
            ...
            boost_rate = st.slider("Boost weight", 0.1, 10.0, 0.8)
        ...
        with col2:
            ...
            arena_rate = st.slider("Arena weight", 0.1, 10.0, 0.1)
            misc_rate = st.slider("Misc. weight", 0.1, 10.0, 2.8)
            elixir_rate = st.slider("Elixir weight", 0.1, 10.0, 0.1)
